  ...
  describe("Mailcheck", function () {
    ...
    describe("cases", function () {
      ...
      it("will not offer suggestions for valid 2ld-tld even if theres a close fully-specified domain", function () {
        expect(Mailcheck.suggest("test@gmx.fr", domains, secondLevelDomains, topLevelDomains)).toBeFalsy();
      });
      ...
      it("prefers gmail.com over msn.com for gml.com with default domains", function () {
        expect(Mailcheck.suggest("test@gml.com", Mailcheck.defaultDomains, Mailcheck.defaultSecondLevelDomains, Mailcheck.defaultTopLevelDomains)).toEqual({
          address: "test",
          domain: "gmail.com",
          full: "test@gmail.com",
        });
      ...
      it("keeps sift4 tie-breaking behavior for custom domain arrays", function () {
        expect(Mailcheck.suggest("test@gml.com", ["msn.com", "gmail.com"])).toEqual({
          address: "test",
          domain: "msn.com",
          full: "test@msn.com",
        });
